...
@RestController
@RequestMapping("/api/cloud-gateway-kafka")
public class CloudGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CloudGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CloudGatewayKafkaResource(KafkaProperties kafkaProperties) {
